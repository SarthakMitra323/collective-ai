...
ALLOWED_ORIGIN = os.getenv(
    "ALLOWED_ORIGIN",
    "https://collective-ai.vercel.app,http://localhost:8000,http://127.0.0.1:8000,http://localhost:3000,http://127.0.0.1:3000",
).split(",")
ALLOWED_ORIGIN_REGEX = os.getenv(
    "ALLOWED_ORIGIN_REGEX",
    r"^(https://([a-z0-9-]+\.)*vercel\.app|http://(localhost|127\.0\.0\.1)(:[0-9]{2,5})?)$",
)
